...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    #
    # Inject passes the value of each iteration into the next iteration.
  end
  ...
  #   # code to read 'file'
  #
  # My answer: because the variable "file" creates a new open file object.
  # This object wastes memory and the filename would have to be closed,
  # because the variable and not the open filename itself is being read.
  # Passing the block directly into the open file automatically closes it when done.
  #
  # When you get to the "AboutSandwichCode" koan, recheck your answer.
  #
  # I sure will. Thanks, koan team..
